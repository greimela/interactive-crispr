...
console.log(values);
var height = 800, width = 600, margin = {top: 20, left: 20, bottom: 20, right: 20};
var radius = 100;

var parent = d3.select('.parent').append('svg')
    .attr({
        height: height,
        width: width
...
function drawHandles() {
    var arc = d3.svg.arc().innerRadius(radius - 5).outerRadius(radius + 5).startAngle(-0.1*Math.PI).endAngle(0.1 * Math.PI);
